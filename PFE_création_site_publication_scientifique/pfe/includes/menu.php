...
<html>
	...
	<div class="mh">
		...
		<?php else : ?>
			<div class="sm" id="d1-champ"><a href="/pfe/procedure.php" class="barh" >Les Procédures <i class="fas fa-clipboard"></i></a></div>
		<?php endif; ?>
		<div class="sm"><a href="/pfe/myaccount.php" class="barh">Mon compte <i class="fas fa-user-circle"></i> </a></div>
		<div class="sm">
		...
		$(document).ready(function(){
			...
			$(".select_ul li").click(function(){
			  ...
			  if(test==="Author"){
					 $("#d1-champ").html("<a href='/pfe/procedure.php' class='barh'>Mes articles <i class='fas fa-newspaper'></i></a>");
			  }else{
				if(test==="Reviewer"){
					 $("#d1-champ").html("<a href='/pfe/procedure.php' class='barh'>Mes demandes <i class='fas fa-envelope-open-text'></i></a>");
				}else{
					if(test==="Administrator"){
						 $("#d1-champ").html("<a href='/pfe/procedure.php' class='barh'>Les Procédures <i class='fas fa-clipboard'></i></a>");
					}
				}
